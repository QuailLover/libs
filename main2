...
local aa = {
    ...
    [47] = function()
        ...
        local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Quail"}}
    ...
    [53] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(0, 80, 180),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 90, 200), Color3.fromRGB(0, 50, 130)),
            AcrylicNoise = 0.94,
            TitleBarLine = Color3.fromRGB(0, 85, 190),
            Tab = Color3.fromRGB(140, 170, 220),
            Element = Color3.fromRGB(0, 115, 255),
            ElementBorder = Color3.fromRGB(0, 55, 120),
            InElementBorder = Color3.fromRGB(0, 65, 140),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(0, 115, 255),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(0, 115, 255),
            DropdownFrame = Color3.fromRGB(100, 160, 230),
            DropdownHolder = Color3.fromRGB(0, 45, 100),
            DropdownBorder = Color3.fromRGB(0, 35, 80),
            DropdownOption = Color3.fromRGB(0, 115, 255),
            Keybind = Color3.fromRGB(0, 115, 255),
            Input = Color3.fromRGB(0, 115, 255),
            InputFocused = Color3.fromRGB(5, 10, 25),
            InputIndicator = Color3.fromRGB(130, 170, 220),
            Dialog = Color3.fromRGB(0, 45, 100),
            DialogHolder = Color3.fromRGB(0, 35, 80),
            DialogHolderLine = Color3.fromRGB(0, 30, 70),
            DialogButton = Color3.fromRGB(0, 45, 100),
            DialogButtonBorder = Color3.fromRGB(0, 75, 165),
            DialogBorder = Color3.fromRGB(0, 55, 120),
            DialogInput = Color3.fromRGB(0, 50, 110),
            DialogInputLine = Color3.fromRGB(120, 170, 230),
            Text = Color3.fromRGB(240, 240, 245),
            SubText = Color3.fromRGB(150, 170, 195),
            Hover = Color3.fromRGB(0, 130, 255),
            HoverChange = 0.04
        }
    end
}
